...
async function main() {
    ...
    const sierraPath = path.join(contractPath, 'enlivora_contracts_Passport721.contract_class.json');
    const casmPath = path.join(contractPath, 'enlivora_contracts_Passport721.compiled_contract_class.json');
